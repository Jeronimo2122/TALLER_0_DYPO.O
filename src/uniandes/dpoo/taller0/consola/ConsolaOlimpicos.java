...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s de un atleta (Taller0)");
	...
	private void ejecutarconsultarpaisatleta()
	{
		...
		String Pais = calculadora.paisdeunatleta(Atleta).darNombre();
		
		System.out.println("El Atleta "+Atleta+" pertence al pais de: "+Pais);
